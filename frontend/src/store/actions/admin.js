...
import { API_PATH_ADMIN_FETCH_STATISTICS, API_PATH_ADMIN_FETCH_GEO } from "../../constant/api";
        ...
        axios
            ...
            .then((response) => {
                ...
                if (response.hasOwnProperty("data") &&
                    ...
                    statList.forEach((item => {item.counts = 100 * item.counts / response.data.total}))
                }
