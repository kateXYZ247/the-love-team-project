...
@Component
public class GetAllUpcomingServicesHandler extends AbstractRequestHandler<String, ServsResponseBody> {
    ...
    protected ServsResponseBody processRequest(String providerId) {
        List<Serv> servList = serviceRepository.getUpcomingServiceByProviderId(Long.parseLong(providerId));
