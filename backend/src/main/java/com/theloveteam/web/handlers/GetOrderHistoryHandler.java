...
@Component
public class GetOrderHistoryHandler extends AbstractRequestHandler<String, OrderHistoryResponseBody>{
    ...
    protected OrderHistoryResponseBody processRequest(String s) {
        OrderHistoryResponseBody orderHistory = OrderHistoryResponseBody.builder()
                .orderHistoryResponseBody(orderService.getOrderByUserId(Long.parseLong(s)))
                .build();
        return orderHistory;
    }
